...
export interface StaffUser {
  ...
  name: string;
  email: string;
  role: 'Org Admin' | 'Inventory Manager' | 'POS Cashier' | 'Storekeeper' | 'Procurement Officer' | 'Auditor';
  location: string;
  ...
  return (
    <div className="p-6 space-y-6 overflow-y-auto flex-1 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        {[
          { role: 'Org Admin', count: users.filter((u) => u.role === 'Org Admin').length, color: 'text-purple-400' },
            ...
            <form onSubmit={handleAddUser} className="space-y-4 text-xs">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Org Admin">Org Admin (Full Administrative Authority)</option>
                </select>
              </div>
