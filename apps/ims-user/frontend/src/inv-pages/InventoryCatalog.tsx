  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Product SKU Master Catalog</h1>
          <p className="text-xs text-slate-400 mt-0.5">
            Manage multi-store inventory balances, pricing, min-stock triggers, and supplier links
          </p>
        </div>
      ...
      <div className="p-4 bg-[#12141f] border border-white/10 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-3">
      ...
      <AddItemModal
        ...
        onItemAdded={(newItem) => setProducts((prev) => [newItem, ...prev])}
      />
      <StockAdjustModal
